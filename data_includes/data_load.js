    ...
    for (var i = 0; i < data_entries.length; i++) {
        ...
        new_item.push({
                html:
                    ...
                    "<tr><td colspan='10'><input type=\"checkbox\" name=\"student_on_task\" id='student_on_task' class='validity'/><label for=\"student_on_task\">Student utterance relates to English language and arts.</label></td></tr>" +
                    "<tr><td colspan='10'><input type=\"checkbox\" name=\"teacher_on_task\" id='teacher_on_task' class='validity'/><label for=\"teacher_on_task\">Teacher utterance relates to English language and arts.</label></td></tr>" +
